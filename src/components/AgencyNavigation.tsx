...
import { X, MessageCircle, Bell, Sun, Moon, Building, Menu, HelpCircle, Calendar, Settings, FileText, BarChart3, TrendingUp } from 'lucide-react'
    ...
    <>
      <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container flex h-16 items-center justify-between px-4">
          {/* Logo */}
          <Link href="/agency/dashboard" className="flex items-center space-x-2">
            <div className="flex items-center space-x-2">
              <Building className="h-6 w-6 sm:h-8 sm:w-8 text-primary" />
              <span className="text-lg sm:text-xl font-bold hidden sm:block">Agency Panel</span>
              <span className="text-lg font-bold sm:hidden">Agency</span>
            </div>
          </Link>
      ...
      <div className="fixed bottom-6 right-6 z-50">
        <Button
          ...
          asChild
        >
          <Link href="/agency/messages" className="flex items-center justify-center">
